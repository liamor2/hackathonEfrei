 ...
 */
final class Version20240412095610 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE users (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, lastname VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, address VARCHAR(255) NOT NULL, role VARCHAR(4) NOT NULL, phone VARCHAR(15) NOT NULL, password VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE wine (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, region VARCHAR(255) NOT NULL, domain VARCHAR(255) NOT NULL, country VARCHAR(255) NOT NULL, alcohol NUMERIC(5, 2) DEFAULT NULL, sparkling TINYINT(1) NOT NULL, volume NUMERIC(15, 2) DEFAULT NULL, bio TINYINT(1) NOT NULL, type VARCHAR(255) NOT NULL, url VARCHAR(255) NOT NULL, varietal VARCHAR(511) NOT NULL, vintage INT NOT NULL, description LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
